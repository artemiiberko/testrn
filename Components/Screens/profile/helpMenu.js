        ...
        >
          <BlurView intensity={100}>
            ...
            >
              ...
              >
                <TouchableOpacity
                  onPress={() => navigation.navigate("Help Suspendisse")}
                  style={styles.menuItem}
                  activeOpacity={0.5}
                >
                  <Text style={styles.menuItemText}>
                    Suspendisse venenatis nec sapien et pretium
                  </Text>
                  <ArrowForwardSvg
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={0.5}
                >
                  <Text style={styles.menuItemText}>Ut non velit sapien</Text>
                  <ArrowForwardSvg
                    fill={theme["color-primary-500"]}
                    height={20}
                  />
